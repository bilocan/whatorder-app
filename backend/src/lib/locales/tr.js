module.exports = {
  ...
  confirmFlowAddressNewDesc: () => 'Aşağıya sokak ve daire yazın',
  ...
  confirmFlowManageAddressesLink: () => 'Adresleri yönet',
  confirmFlowManageTitle: () => 'Adresler',
  confirmFlowManageHint: () => 'En fazla 5 kayıtlı adres',
  confirmFlowManageSave: () => 'Kaydet',
  confirmFlowManageSetDefault: () => 'Varsayılan yap',
  ...
  menuFlowCartHint: () => 'Çıkarmak için işaretleyin, sonra Çıkar’a dokunun. Veya doğrudan siparişi verin.',
  menuFlowRemoveLabel: () => 'Ürünleri çıkar:',
  menuFlowRemoveSelected: () => 'Seçilenleri çıkar',
  ...
  askDeliveryAddress: () => '📍 Konumunuzu paylaşın veya teslimat adresinizi yazın.\n\nİpucu: sokak + kapı no + PLZ (örn. Beispielgasse 12, 1010 veya Beispielgasse 12/3 1010).',
  askDeliveryAddressShare: () => '📍 Lütfen teslimat konumunuzu paylaşın.',
  deliveryAddressConfirm: (address) => `📍 Bulduğumuz adres:\n*${address}*\n\nDoğru mu?`,
  deliveryAddressConfirmYes: () => 'Evet',
  deliveryAddressConfirmEdit: () => 'Düzenle',
  deliveryAddressInvalid: () => 'Bu adresi doğrulayamadık. Lütfen tekrar yazın veya konumunuzu paylaşın.',
  deliveryAddressGeocodeFailed: () => 'Pin’den adres okuyamadık. Lütfen sokak ve kapı numarasını yazın.',
  askDeliveryUnit: () => 'Hangi daire / giriş?\n\n*Stiege / Tür / Top* yazın (örn. Top 14 veya Stiege 1, Top 8).\nDaire numarası yoksa *Haus* yazın.',
  deliveryUnitInvalid: () => 'Bu bir daire numarası gibi durmuyor. Örn. *Top 14*, *Stiege 1, Top 8* veya *Haus* yazın.',
  ...
  intentUnmatchedWithSuggestion: (name, list) => `"${name}" menüde yok. Hangisini kastettiniz?\n\n${list}\n\nNumara veya adı yaz.`,
