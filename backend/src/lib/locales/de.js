module.exports = {
  ...
  itemsAdded: (summary, count, total) => `✅ ${summary} hinzugefügt.\n🛒 ${count} Artikel · €${total}`,
  itemsAddedCount: (addedQty, count, total) => `✅ ${addedQty} Artikel hinzugefügt.\n🛒 ${count} Artikel · €${total}`,
  ...
  confirmFlowAddressNewDesc: () => 'Straße und Wohnung unten eingeben',
  ...
  confirmFlowManageAddressesLink: () => 'Adressen verwalten',
  confirmFlowManageTitle: () => 'Adressen',
  confirmFlowManageHint: () => 'Bis zu 5 gespeicherte Adressen',
  confirmFlowManageSave: () => 'Speichern',
  confirmFlowManageSetDefault: () => 'Als Standard',
  ...
  menuFlowCartHint: () => 'Artikel zum Entfernen markieren, dann Entfernen tippen. Oder direkt Bestellung aufgeben.',
  menuFlowRemoveLabel: () => 'Artikel entfernen:',
  menuFlowRemoveSelected: () => 'Ausgewählte entfernen',
