module.exports = {
  ...
  confirmFlowTypeLabel: () => 'Type',
  confirmFlowAddressChoiceLabel: () => 'Delivery address',
  confirmFlowAddressNew: () => 'New address',
  confirmFlowAddressNewDesc: () => 'Enter street and apartment below',
  confirmFlowAddressLabel: () => 'Street',
  confirmFlowAddressEmpty: () => 'No address — tap Manage addresses.',
  ...
  confirmFlowManageAddressesLink: () => 'Manage addresses',
  confirmFlowManageTitle: () => 'Addresses',
  confirmFlowManageHint: () => 'Up to 5 saved addresses',
  confirmFlowManageSave: () => 'Save',
  confirmFlowManageSetDefault: () => 'Set as default',
