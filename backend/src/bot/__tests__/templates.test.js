...
const FUNCTION_KEYS = [
  ...
  'confirmListHeader', 'confirmListBtn', 'confirmListSection',
  ...
  'confirmFlowCta', 'confirmFlowFooter', 'confirmFlowBackToCart',
  'confirmFlowNameLabel', 'confirmFlowTypeLabel', 'confirmFlowAddressLabel', 'confirmFlowNoteLabel',
  'confirmFlowTypePickup', 'confirmFlowTypeDelivery',
  'confirmFlowErrorName', 'confirmFlowErrorAddress',
  ...
  'menuFlowCartTitle', 'menuFlowCartHint', 'menuFlowRemoveLabel', 'menuFlowRemoveSelected',
