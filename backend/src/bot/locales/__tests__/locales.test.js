...
describe('de locale', () => {
  ...
  test('deliveryPickupOption', () => expect(str(de.deliveryPickupOption())).toBe(true));
  test('deliveryPickupOptionDesc', () => expect(str(de.deliveryPickupOptionDesc())).toBe(true));
...
describe('tr locale', () => {
  ...
  test('deliveryPickupOption', () => expect(str(tr.deliveryPickupOption())).toBe(true));
  test('deliveryPickupOptionDesc', () => expect(str(tr.deliveryPickupOptionDesc())).toBe(true));
