...
description: Check whatorder-app commits against vault docs for drift. Use when the user says "vault sync check", "sync check", "freshness check", or "babysit the vault".
---
